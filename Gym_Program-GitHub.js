...
window.PROGRAM = {
  ...
  days: [
    ...
    /* ── D2 · Upper Body ── */
    {
      ...
      blocks: [
        ...
        },
        {
          id: 'D2-prehab',
          type: 'prehab',
          title: 'CHEST & SHOULDERS — SECONDARY',
          icon: '🏋️',
          duration: '15 min',
          exercises: [
            {
    ...
    /* ── D4 · Hip & Core ── */
    {
      ...
      blocks: [
        ...
        },
        {
          id: 'D4-prehab',
          type: 'prehab',
          title: 'CORE & STABILITY — SECONDARY',
          icon: '⚡',
          duration: '18 min',
          exercises: [
            {
      ...
      blocks: [
        {
          id: 'D5-walk',
          type: 'cardio',
          title: 'Darebin Creek Trail',
          logType: 'session',
          exercises: [
            {
              id: 'D5-walk-log',
              name: 'Darebin Trail Walk',
              prescription: 'Log duration + distance',
              sets: 1, reps: 1, bodyweight: true, weight: '',
              note: 'Tick to complete. Log time (min) and distance (km).',
              muscles: 'Cardiovascular · Lower body · POTS venous return',
              cues: [
                'Pace to comfort — not a speed walk',
                'Compression leggings and water before leaving',
                'Stop and sit on a bench if dizzy or HR spikes',
    ...
    /* ── D6 · Active Day ── */
    {
      ...
      commute: false,
      duration: 'Free',
      note: 'Free choice — yoga, walk, swim, easy ride, or rest. No structured gym session. Pick whatever feels right for your body and POTS symptoms today.',
      blocks: [],
    },
