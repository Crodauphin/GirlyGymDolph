/* ══════════════════════════════════════════
   ...
   Schema contract: v1.2 · Engine: v0.9.11
...
window.PROGRAM = {
  ...
  /*
   * cardioPool — Emily's cardio options.
   * No commute entry: commute doesn't apply given POTS and hEDS.
   * Omitting it means no day shows a commute option and no commute: false
   * flag is needed on training days.
   * logFields now uses camelCase per contract v1.2.
   * NOTE (B6): cardioPool renders on ALL training days including D5 (Darebin Walk).
   * Per-day cardio suppression is a v0.9.12 engine request — not yet available.
   */
  cardioPool: [
  ...
  milestones: {
    ...
    /*
     * WEEKLY — consistency streaks, fully derived from history.
     * Pitched to Emily's capacity with POTS, not Albin's.
     * Step 1: 3 training days (D1+D2+D4) — reachable even on a moderate-symptom week.
     * Step 2: 3 training days + active day (D6) — adds one low-intensity day.
     * No timeline on repeating steps — engine shows live streak count instead.
     * requires keys must match actual day.type values in this program.
     */
    weekly: [
      {
        metric: 'Training week',
        target: '3 training days logged in one week',
        icon: '📅',
        repeats: 'weekly',
        requires: { training: 3 },
      },
      {
        metric: 'Training + active',
        target: '3 training days + one active day in the same week',
        icon: '🔥',
        repeats: 'weekly',
        requires: { training: 3, cardio_day: 1 },
      },
    ],

    /*
     * PERFORMANCE — wellbeing and capacity markers.
     * No specific performance target chosen yet — ladder tracks
     * what matters: consistency, feeling better, pregnancy readiness.
     * Replace steps once Emily identifies a goal she wants to chase.
     * First step removed from here and moved to weekly ladder above.
     */
    performance: [
      {
    ...
    /*
     * BODYCOMP — based on body composition scanner readings:
     *   Baseline May 25: weight 69.5 kg · BF% ~33.9% · muscle 43.1 kg · athlete index 62
     *   Recent  Jun 14:  weight 70.7 kg · BF% ~34.2% · muscle 43.6 kg · athlete index 70
      ...
      blocks: [
        {
          ...
          exercises: [
            {
              id: 'D1-w1',
              name: 'Seated Ankle Rolls + Calf Pumps',
              sets: 1, reps: '15',
              bodyweight: true,
              note: 'POTS: venous return activation before standing.',
              muscles: 'Ankle stabilisers · Calf pump',
              cues: 'Slow full circles each direction, then flex and point 15 times. POTS: activates calf pump before standing — do not skip.',
              yt: 'ankle circles calf pumps seated warm up',
            },
            {
              id: 'D1-w2',
              name: 'Seated Leg Swings + Hip Circles',
              sets: 1, reps: '10',
              bodyweight: true,
          ...
          exercises: [
            {
              ...
              cues: 'Drive through heels. Squeeze glutes at top — hold 1 sec. hEDS: stop when hips are level with torso — do not push further back. POTS: this exercise supports venous return.',
            ...
            },
            {
              ...
              sets: 3, reps: '15',
              note: 'Both directions. Slow and controlled. Hip stability + pregnancy prep.',
      ...
      blocks: [
        {
          ...
          exercises: [
            {
              id: 'D2-w1',
              name: 'Shoulder Rolls + Neck Tilts',
              sets: 1, reps: '10',
              bodyweight: true,
            ...
            {
              id: 'D2-w2',
              name: 'Band Face Pulls / Scapula Retractions',
              sets: 2, reps: '15',
              bodyweight: true,
        ...
        },
        {
          ...
          exercises: [
            ...
            {
              id: 'D2-s4',
              name: 'Rear Delt Fly (Pec Fly Machine)',
              sets: 2, reps: '15',
      ...
      blocks: [
        {
          ...
          exercises: [
            ...
            {
              id: 'D4-w2',
              name: 'Ankle Pumps + Calf Raises (Standing)',
              sets: 1, reps: '20',
              bodyweight: true,
        ...
        },
        {
          ...
          exercises: [
            ...
            {
              id: 'D4-s4',
              name: 'Seated Back Extension (Bodyweight)',
              sets: 2, reps: '12',
              bodyweight: true,
