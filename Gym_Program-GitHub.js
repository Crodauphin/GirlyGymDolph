...
window.PROGRAM = {
  ...
  milestones: {
     ...
     * distance, a body composition score).
     */
    performance: [
      {
    ...
    /*
     * BODYCOMP — based on body composition scanner FIT readings:
     ...
     *     Weight will be tracked on the body composition scanner but not used as a milestone trigger.
     *
     * auto-nudge deliberately omitted on all steps — body composition scanner readings vary with
  ...
  days: [
          ...
          exercises: [
            {
              ...
              prescription: '1 x walk',
              sets: 1, reps: 1,
              note: 'PRIMARY - Walk at your own pace. POTS: stop and sit if dizzy — plenty of benches on the trail. Compression leggings + water essential.',
              muscles: 'Cardiovascular · Lower body · POTS venous return',
              cues: [
                'POTS: pace to comfort — this is not a speed walk',
                'Compression leggings and water before you leave',
                'Stop and rest on a bench if dizzy or HR spikes',
                'Rise slowly if you sit down during the walk',
                'Log time (min) and distance (km) when done',
              ],
    ...
    /* ── D6 · Active Day ── */
    {
      ...
      type: 'stretch',
      duration: 60,
      note: 'Free-choice active day. Pick whatever feels good today. All options are low-intensity by design — skip anything that aggravates POTS symptoms.',
      blocks: [
        {
          id: 'D6-picker',
          type: 'cardio',
          bodyPart: 'Choose your activity',
          icon: '🌸',
          duration: '30–60 min',
          exercises: [
            {
              ...
              prescription: '1 x session',
              sets: 1, reps: 1,
              note: 'PRIMARY - Home yoga, guided app, or gym stretch session. hEDS: hold at first tension. POTS: legs-up-the-wall at the end is always a great finish.',
              muscles: 'Full body mobility · Pelvic floor · Parasympathetic activation',
              cues: [
                'hEDS: hold at first tension — never force range',
                'POTS: end with legs-up-the-wall for 3–5 min',
                'Pelvic floor engagement recommended in any session',
                'Even 20 min of gentle stretching counts',
              ],
              yt: 'gentle yoga POTS hypermobility safe',
              bodyweight: true,
            },
            {
              id: 'D6-walk',
              ...
              prescription: '1 x walk',
              sets: 1, reps: 1,
              note: 'Alt 1 - Neighbourhood walk, park or trail at a comfortable pace. POTS: compression leggings + water. Rest if needed.',
              muscles: 'Cardiovascular · Lower body · Venous return',
              cues: [
                'POTS: compression leggings and water before leaving',
                'Comfortable conversational pace — not a workout',
                'Rest on a bench if dizzy',
                'Rise slowly if you sit down during the walk',
              ],
              yt: 'walking benefits POTS gentle exercise',
              bodyweight: true,
            },
            {
              id: 'D6-swim',
              ...
              prescription: '1 x session',
              sets: 1, reps: 1,
              note: 'Alt 2 - Lap swim or gentle aqua session. POTS: excellent — horizontal position supports venous return. Rise slowly from pool.',
              muscles: 'Cardiovascular · Full body · Venous return',
              cues: [
                'POTS: one of the best activities — horizontal position reduces orthostatic load',
                'Easy pace — not a race session',
                'Rise slowly from pool — pause at edge before standing',
                'hEDS: avoid aggressive flip turns or push-offs',
              ],
              yt: 'swimming POTS exercise benefits',
              bodyweight: true,
            },
            {
              id: 'D6-bike',
              name: 'Easy Ride',
              prescription: '1 x ride',
              sets: 1, reps: 1,
              note: 'Alt 3 - Gentle flat ride at easy pace. POTS: avoid hills that spike HR. Bring water. Stop if dizzy.',
              muscles: 'Cardiovascular · Quads · Calves · Venous return',
              cues: [
                'POTS: flat route only — avoid hills that spike HR',
                'Easy conversational pace throughout',
                'Bring water and stop if dizzy',
                'Dismount slowly — pause before walking',
              ],
              yt: 'easy cycling POTS low intensity',
              bodyweight: true,
            },
            {
              id: 'D6-rest',
              name: 'Rest',
              prescription: '1 x rest day',
              sets: 1, reps: 1,
              note: 'Alt 4 - Body needs rest today — that is a valid choice. Sleep, hydrate, eat well.',
              muscles: 'Recovery',
              cues: [
                'Rest is part of the program — not a skip',
                'Prioritise sleep and hydration',
                'POTS: gentle calf pumps while seated still count',
              ],
              yt: 'rest day active recovery benefits',
              bodyweight: true,
            },
          ],
        },
